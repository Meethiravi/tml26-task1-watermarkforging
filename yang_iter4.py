...
TEMP_OUT_DIR  = Path("/home/atml_team060/tml26_task4/submission_yang_iter4")
FILE_PATH     = "/home/atml_team060/tml26_task4/submission_yang_iter4.zip"
...
def estimate_pattern(source_paths, clean_pool, target_h, target_w):
    ...
    wm_mean = np.median(wm_stack, axis=0)

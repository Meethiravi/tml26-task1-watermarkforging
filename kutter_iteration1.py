...
for source_wm, target_start, target_stop in CATEGORIES:
    ...
    # Subtract per-channel DC offset so watermark is a zero-mean residual
    # This isolates the watermark from the "blurry average content"
    ...
    for number in range(target_start, target_stop + 1):
        ...
        # Add watermark residual to clean target
